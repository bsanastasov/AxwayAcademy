...
@WebServlet(urlPatterns = { "/doCreateMovie" })
public class DoCreateMovieServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public DoCreateMovieServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (errorString == null) {
			try {
				...
				errorString = "Failed to insert movie: " + e.getMessage();
			}
		}
		...
		if (errorString != null) {
			RequestDispatcher dispatcher = request.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/createMovieView.jsp");
